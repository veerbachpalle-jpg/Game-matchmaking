 ...
 */
export declare function debugApiRequest(method: string, endpoint: string, timeout?: number | undefined): void;
/**
 * Debug an API response end.
 * Logs essential info without exposing sensitive data.
 */
export declare function debugApiResponse(method: string, endpoint: string, status?: number | undefined, error?: unknown | undefined, duration?: number | undefined, headers?: Record<string, string> | undefined): void;
/**

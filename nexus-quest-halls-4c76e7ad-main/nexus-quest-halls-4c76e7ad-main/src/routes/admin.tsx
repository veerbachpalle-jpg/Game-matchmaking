          ...
          <Panel key={u._id} className="flex flex-wrap items-center gap-4">
            {u.avatar ? (
              <img
                ...
                className="h-11 w-11 clip-blade object-cover"
                loading="lazy"
              />
            ) : (
              <span className="grid h-11 w-11 place-items-center clip-blade bg-primary/15 font-display text-sm text-primary">
            ...
            <button
              ...
              className="clip-blade border border-destructive/50 px-5 py-3 font-display text-xs font-bold uppercase tracking-[0.2em] text-destructive transition-colors hover:bg-destructive/10"
            >
              Remove
            </button>
          </Panel>

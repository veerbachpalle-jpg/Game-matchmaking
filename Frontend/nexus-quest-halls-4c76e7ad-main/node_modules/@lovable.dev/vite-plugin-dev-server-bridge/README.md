...
The plugin injects a capture-phase browser listener before app scripts, posts reports to `POST /__lovable/error-collector`, and resets the JSONL output when the dev server starts.

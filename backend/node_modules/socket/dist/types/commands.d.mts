...
export declare const rootCommands: {
    analytics: {
        description: string;
        hidden: boolean;
        run: (argv: string[] | readonly string[], importMeta: ImportMeta, { parentName }: import("./utils/meow-with-subcommands.mts").CliCommandContext) => Promise<void>;
    };
    "audit-log": {
        description: string;
        hidden: boolean;
    ...
    cdxgen: {
        description: string;
        hidden: boolean;
        run: (argv: string[] | readonly string[], importMeta: ImportMeta, context: import("./utils/meow-with-subcommands.mts").CliCommandContext) => Promise<void>;
    };
    ...
    patch: {
        description: string;
        hidden: boolean;
        run: (argv: string[] | readonly string[], _importMeta: ImportMeta, _context: import("./utils/meow-with-subcommands.mts").CliCommandContext) => Promise<void>;
    };
    "raw-npm": {
        description: string;
        hidden: boolean;
        run: (argv: readonly string[], importMeta: ImportMeta, { parentName }: import("./utils/meow-with-subcommands.mts").CliCommandContext) => Promise<void>;
    };
    "raw-npx": {
        description: string;
        hidden: boolean;

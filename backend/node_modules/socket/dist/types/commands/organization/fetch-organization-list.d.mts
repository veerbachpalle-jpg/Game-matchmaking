...
export type Organization = SocketSdkSuccessResult<'getOrganizations'>['data']['organizations'][string];
export type Organizations = Organization[];
export type OrganizationsData = {
    organizations: Organizations;
};
export type OrganizationsCResult = CResult<OrganizationsData>;
export declare function fetchOrganization(options?: FetchOrganizationOptions | undefined): Promise<OrganizationsCResult>;

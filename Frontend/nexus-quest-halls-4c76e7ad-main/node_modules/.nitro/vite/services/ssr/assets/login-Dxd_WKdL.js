import { n as useAuth } from "./use-auth-xjOyXtJV.js";
import { a as Field, n as Alert, o as Panel, r as ArenaShell, t as ActionButton } from "./arena-shell-pp1dsK4G.js";
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs(Panel, {
					...
					children: [
						/* @__PURE__ */ jsx("div", { className: "absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-primary/50 to-transparent" }),
						/* @__PURE__ */ jsx("div", { className: "absolute right-4 top-4 h-12 w-12 clip-blade border border-primary/10 opacity-30" }),
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
							className: "mb-6 flex items-center gap-3",
							children: [/* @__PURE__ */ jsx("span", {
								className: "flex h-8 w-8 items-center justify-center clip-blade bg-primary/15 ring-1 ring-primary/30",
								children: /* @__PURE__ */ jsx("span", { className: "h-2 w-2 rotate-45 bg-primary" })
							...
							children: [
								...
								/* @__PURE__ */ jsxs("label", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("input", {
											...
											className: "sr-only"
										}), /* @__PURE__ */ jsx("div", { className: `absolute top-0.5 h-4 w-4 clip-blade transition-all duration-200 ${admin ? "left-4 bg-accent" : "left-0.5 bg-muted-foreground/40"}` })]
									}), /* @__PURE__ */ jsx("span", {
								...
								/* @__PURE__ */ jsx(ActionButton, {
									...
									children: busy ? /* @__PURE__ */ jsxs("span", {
										...
										children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 animate-pulse rounded-full bg-current" }), "Authenticating…"]
									}) : "Enter Arena"
								})
							]
						})] }),

...
* @ {object} data
*/
module.exports = async (url, authorization = null, headers = {}, params = {}, streamListener = null, options = null) => {
  ...
  let result = await send('POST', url, {}, authorization, headers, null, body, streamListener, options);
  return {

...
var $$splitComponentImporter$1 = () => import("./matches-Ch666InA.js");
...
function StatusChip({ status }) {
	...
	return /* @__PURE__ */ jsxs("span", {
		...
		children: [/* @__PURE__ */ jsx("span", { className: `h-1.5 w-1.5 rounded-full flex-shrink-0 ${config.dot}` }), config.label]
	});
}
//#endregion
//#region src/routes/match.$matchId.tsx
var $$splitComponentImporter = () => import("./match._matchId-CD_jcsTS.js");

import { i as api, n as useAuth } from "./use-auth-xjOyXtJV.js";
import { a as Field, c as StatCard, i as Badge, l as SuccessNotice, n as Alert, o as Panel, r as ArenaShell, s as SectionLabel, t as ActionButton } from "./arena-shell-pp1dsK4G.js";
...
function ProfilePage() {
	...
	if (!user) return /* @__PURE__ */ jsx(ArenaShell, {
	...
	return /* @__PURE__ */ jsx(ArenaShell, {
		eyebrow: "Dossier",
		title: user.username,
		subtitle: user.email,
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs(Panel, {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [user.coverimage ? /* @__PURE__ */ jsx("img", {
								src: user.coverimage,
							...
							}), /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-surface/85 to-transparent" })]
						}),
						/* @__PURE__ */ jsxs("div", {
						...
						/* @__PURE__ */ jsx("div", { className: "absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/15 to-transparent" })
					]
				}), /* @__PURE__ */ jsx("div", {
					...
					children: [{
						...
						accent: true
					}].map(({ label, value, accent }) => /* @__PURE__ */ jsx(StatCard, {
						label,
						value,
						accent
					}, label))
				...
				children: [
					...
					activeTab === "overview" && /* @__PURE__ */ jsxs(Panel, {
						padding: "p-6",
						children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-primary/30 to-transparent" }), /* @__PURE__ */ jsxs("div", {
							className: "flex flex-col gap-5",
							children: [/* @__PURE__ */ jsx(SectionLabel, { children: "Account Information" }), /* @__PURE__ */ jsx("div", {
					...
					activeTab === "squad" && /* @__PURE__ */ jsxs(Panel, {
						padding: "p-6",
						children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-primary/30 to-transparent" }), /* @__PURE__ */ jsxs("div", {
							className: "flex flex-col gap-5",
							children: [
								...
								notice && /* @__PURE__ */ jsx(SuccessNotice, { children: notice }),
								/* @__PURE__ */ jsx(Alert, { children: error }),
								user.friends && user.friends.length > 0 ? /* @__PURE__ */ jsx("div", {
									className: "flex flex-col gap-2",
									children: user.friends.map((fid) => /* @__PURE__ */ jsxs("div", {
					...
					activeTab === "security" && /* @__PURE__ */ jsxs(Panel, {
						padding: "p-6",
						children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-primary/30 to-transparent" }), /* @__PURE__ */ jsxs("div", {
							className: "flex flex-col gap-5",
							children: [
								/* @__PURE__ */ jsx(SectionLabel, { children: "Change Password" }),
								/* @__PURE__ */ jsx("div", {

import { a as getToken, n as useAuth, r as API_BASE_URL } from "./use-auth-xjOyXtJV.js";
import { useEffect, useRef, useState } from "react";
import { Link, useRouter } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { io } from "socket.io-client";
//#region src/hooks/use-matchmaking.ts
...
//#endregion
//#region src/components/arena-shell.tsx
var LINKS = [
	{
		to: "/play",
		label: "Matchmaking"
...
function CornerScrew({ position }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "h-2 w-0.5 rotate-45 bg-slate-950 shadow-[0_0_1px_rgba(255,255,255,0.4)]" }), /* @__PURE__ */ jsx("div", { className: "absolute h-2 w-0.5 -rotate-45 bg-slate-950 shadow-[0_0_1px_rgba(255,255,255,0.4)]" })]
	});
}
function ArenaNav() {
	...
	return /* @__PURE__ */ jsx("header", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsx("div", { className: "absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-cyan-400/80 to-transparent" }),
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs(Link, {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: /* @__PURE__ */ jsx("span", { className: "h-2.5 w-2.5 rotate-45 bg-cyan-400 transition-transform group-hover:rotate-[135deg] duration-500 shadow-[0_0_8px_rgba(6,182,212,0.9)]" })
							}), /* @__PURE__ */ jsx("span", {
						...
						/* @__PURE__ */ jsxs("nav", {
							...
							children: [LINKS.map((l) => /* @__PURE__ */ jsx(Link, {
								...
								children: l.label
							}, l.to)), user?.role === "admin" && /* @__PURE__ */ jsx(Link, {
								to: "/admin",
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: user ? /* @__PURE__ */ jsxs(Fragment, { children: [
								mm.connected && mm.ping !== null && /* @__PURE__ */ jsxs("span", {
									className: "hidden items-center gap-1.5 font-mono text-[10px] uppercase tracking-[0.18em] text-muted-foreground sm:flex",
									children: [
										/* @__PURE__ */ jsx("span", { className: `h-1.5 w-1.5 rounded-full animate-pulse ${mm.ping < 60 ? "bg-emerald-400 shadow-[0_0_6px_1px_#34d399]" : mm.ping < 120 ? "bg-amber-400" : "bg-destructive"}` }),
										mm.ping,
										"ms"
									]
								}),
								...
								/* @__PURE__ */ jsxs("button", {
									...
									children: [
										/* @__PURE__ */ jsx(CornerScrew, { position: "top-left" }),
										/* @__PURE__ */ jsx(CornerScrew, { position: "bottom-right" }),
										"Log out"
									]
								})
				...
				/* @__PURE__ */ jsx("div", { className: "absolute bottom-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-cyan-500/30 to-transparent" })
			]
		})
	});
}
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			eyebrow && /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("div", { className: "h-px w-8 bg-gradient-to-r from-transparent to-cyan-400/70" }),
					/* @__PURE__ */ jsx("span", {
						className: "font-mono text-[10px] uppercase tracking-[0.4em] text-cyan-400",
						children: eyebrow
					}),
					/* @__PURE__ */ jsx("div", { className: "h-px flex-1 bg-gradient-to-l from-transparent to-cyan-400/30" })
				]
			}),
			/* @__PURE__ */ jsx("h1", {
...
function ArenaShell({ eyebrow, title, subtitle, children }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx(SceneOverlay, {}),
			/* @__PURE__ */ jsx(ArenaNav, {}),
			/* @__PURE__ */ jsxs("main", {
...
function Panel({ children, className = "", glow = false, padding = "p-6", ...props }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx(CornerScrew, { position: "top-left" }),
			/* @__PURE__ */ jsx(CornerScrew, { position: "bottom-right" }),
			/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-cyan-400/30 to-transparent" }),
			/* @__PURE__ */ jsx("div", {
				className: padding,
				children
			})
...
function SectionLabel({ children }) {
	return /* @__PURE__ */ jsxs("span", {
		...
		children: [/* @__PURE__ */ jsx("span", { className: "h-px w-4 bg-cyan-400/60" }), children]
	});
}
function Field({ label, ...props }) {
	return /* @__PURE__ */ jsxs("label", {
		...
		children: [/* @__PURE__ */ jsxs("span", {
			...
			children: [/* @__PURE__ */ jsx("span", { className: "h-px w-3 bg-cyan-400/50 transition-all group-focus-within:w-5 group-focus-within:bg-cyan-400" }), label]
		}), /* @__PURE__ */ jsx("input", {
			...props,
...
function Alert({ children }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 flex-shrink-0 rounded-full bg-destructive shadow-[0_0_6px_1px_var(--color-destructive)]" }), /* @__PURE__ */ jsx("span", {
...
function SuccessNotice({ children }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary shadow-[0_0_6px_1px_var(--color-primary)]" }), /* @__PURE__ */ jsx("span", {

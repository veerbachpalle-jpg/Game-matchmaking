...
* @ {object} data
*/
module.exports = async (url, authorization = null, headers = null, params = {}, streamListener = null, options = null) => {

  let result = await send('POST', url, {}, authorization, headers, params, null, streamListener, options);
  return {
